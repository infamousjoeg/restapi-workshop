...
export const city = "Nashville";
export const presenter = "Joe Garcia";
export const title = "DevOps Security Engineer";
export const presentationBaseURL = "https://cyberark.joegarcia.dev"
...
<ul>
  <Appear>
    ...
    <li>Go over agenda (now)</li>
    <li>v9 to v10 API Changes</li>
    <li>Exploring Support Tools</li>
...
<ul>
  <Appear>
    <li>Create Safe & Safe Members Script (CyberArk Safe Factory)</li>
    <li>Q&A Session</li>
  </Appear>
</ul>
